...
FLAGS = flags.FLAGS
# DIRECTORIES
flags.DEFINE_string('dataset_dir', "./dataset_preprocessed", 'Dataset directory.')
...
# input-output
flags.DEFINE_string('train_dataset','SKIJUMP','Choose train dataset')
...
flags.DEFINE_integer('masked_joints',8,'Number of masked joints: 13,14,6')
flags.DEFINE_string('masking_mode','end_effectors','Choose masking mode.')
